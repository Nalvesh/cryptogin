...
<?php
		...
		<form action="bidin.php?nid=<?php echo $row['id'];?>" method="POST" name=formfetch>
	  ...
	  <div class=container1 style="margin-top:-40%;" >
		...
		<label for="name" ><b>New Price </b></label>
		<input type="text" placeholder="New Price" name="nprice" class=pr required /><img src="1611360.png" align="center" height=20px width=20px /><br><br>
    

	
	<button type="submit" name="submit" class="registerbtn">Make a offer</button>
